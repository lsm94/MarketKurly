...
<%-- 문제) 템플릿 페이지(index.jsp)가 아닌 스레드가 이동된 JSP 문서(main.jsp)를 요청한 경우   
해당 자원을 찾을 수 없어 404 에러 발생 가능 --%> 
<%-- => 요청하는 JSP 문서와 응답 결과를 제공하는 JSP 문서의 경로가 다른 경우 문제 발생 --%>
<%-- <img src="images/Koala.jpg" width="300"> --%>

<%-- 해결)JSP 문서에서 필요한 자원을 표현할 경우 절대경로로 표현하는 것을 권장 --%>
...
<%-- 문제)웹자원이 저장된 ContextRoot 디렉토리의 경로가 변경될 경우 해당 자원을 찾을 수 없어 404 에러 발생 가능 --%>
<%-- <img src="/jsp/action/template_site/images/Koala.jpg" width="300"> --%>

<%-- 해결) 메소드 호출하여 ContextRoot 디렉토리의 경로를 반환받아 절대경로로 표현  --%>
