...
<%
	...
	if(!passwd.equals(loginMember.getPasswd())) {
		...
		out.println("<script type='text/javascript'>");
		out.println("location.href='index.jsp?workgroup=member&work=password_confirm&action=modify';");
		out.println("</script>");
		return;	
	}
%>
...
<form action="index.jsp?workgroup=member&work=member_modify_action" method="post" id="join">
<fieldset>
	<legend>회원정보</legend>
	<ul>
		<li>
