...
<%
	...
	// => 속성명을 이용하여 속성값을 구분 - 내장객체가 다른 경우 같은 속성명 사용 가능(비권장)
	// => 속성명이 같은 경우 기존 속성값 대신 새로운 속성값으로 저장(변경)
...
<body>
	...
	<hr>
	<%
		//내장객체에 저장된 속성값을 속성명을 이용하여 객체로 반환받아 저장
		// => Object 객체로 반환되므로 명시적 객체 형변환해야만 사용 가능
		// => 내장객체에 속성명에 대한 속성값이 없는 경우 null 반환 
